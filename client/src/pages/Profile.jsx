...
<p className='text-sm self-center'>
  ...
  ""
      ...
      <div className='flex justify-between mt-5'>
        ...
        className='text-red-700 cursor-pointer'>Apagar contar</span>
      ...
      <span className='text-green-700 self-center'>
        {updateSuccess ? 'Actualizado com sucesso!' : ""}
      </span>
      
      <Link to="/mostrar-item"className='text-green-700 w-full'>Mostrar seus items</Link>
    </div>
  )
}
