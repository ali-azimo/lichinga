...
export default function UpdateListing() {
    ...
    const getPriceLabel = () => {
        if (formData.transactionType === 'aluguel') {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-center my-7'>Atualizar Anúncio</h1>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button
                        ...
                        {loadingSubmit ? 'Atualizando...' : 'Atualizar Anúncio'}
                    </button>
